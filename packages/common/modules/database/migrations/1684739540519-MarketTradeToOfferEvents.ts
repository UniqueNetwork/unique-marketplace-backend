  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      ...
      await queryRunner.query(`
        ...
        SELECT ID AS offer_id, 'Buy' AS event_type, block_number_buy AS block_number, address_buyer AS address, 1 AS amount, 10 AS commission, 'NFT' AS collection_mode,
        network, buy_created_at AS created_at,ask_created_at AS updated_at FROM market_trade
    `);
